...
- `backend/app/data_sources.py`
  ...
  - Includes dedicated live-source adapters for ESPN scoreboards/discovery, Schema.org schedules, FIFA rankings, Sports Mole injuries, Transfermarkt injuries/squads, BetExplorer/OddsChecker odds, and World Football Elo rankings.
