...
- `backend/app/data_sources.py`
  ...
  - Includes dedicated live-source adapters for ESPN scoreboards/discovery, Sports Mole injuries, Transfermarkt injuries/squads, OddsChecker odds, and World Football Elo rankings.
